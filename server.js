...
app.get('/', function (req, res) {
  ...
  if (question == 'Please return OK so that I know your service works.'){
    ...
    res.send('Cover Letter: https://drive.google.com/file/d/1Sasyeds1iduBg1FNpelv7vuJulK3xSs9/view?usp=sharing,
    Resume: https://drive.google.com/file/d/1UQB_sFeRWeQ6upbExBmSMIcmYEqntT8T/view?usp=sharing');
